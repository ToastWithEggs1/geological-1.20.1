...
public class StrangeSandstoneFeature extends Feature<DefaultFeatureConfig> {

    public StrangeSandstoneFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            Geological.LOGGER.info("Placed exposed Strange Sandstone at {}", pos);

            world.setBlockState(pos, ModBlocks.STRANGE_SANDSTONE.getDefaultState(), 3);
            return true;
        }

        Geological.LOGGER.info("No sandstone found near {}", origin);
        return false;
    }
}