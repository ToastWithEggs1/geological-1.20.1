...
public class StrangeDeepslateFeature extends Feature<DefaultFeatureConfig> {

    public StrangeDeepslateFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            Geological.LOGGER.info("Placed exposed Strange Deepslate at {}", pos);

            world.setBlockState(pos, ModBlocks.STRANGE_DEEPSLATE.getDefaultState(), 3);
            return true;
        }

        Geological.LOGGER.info("No deepslate found near {}", origin);
        return false;
    }
}